...
function CardList () {
  const contents = [
    { 
      ...
      title: '"나의 단짝친구"란', 
      description: 
        ' "나의 단짝친구" 프로젝트는 SSAFY에서 시작한 프로젝트로, 장기 입원으로 지친 소아 환우들을 위한 IoT 기기 개발을 목표로 시작되었다. \
    ...
    { 
      ...
      title: '기능 소개', 
      description: 
        ' 본 프로젝트의 주된 기능은 얼굴인식, TTS, 3D 렌더링이다.\
        ...
        \n최종 기술 스택은 React(프론트), SpringBoot(백), 라즈베리파이(IoT)를 사용했고 그 외에도 Three.js, OpenCV, Naver CLOVA, MySQL, AWS, Firebase, Jenkins 등을 활용했다.',
    ...
    { 
      ...
      title: '기대 효과', 
      description: 
        ' 이 프로젝트를 통해 얻을 수 있는 기대효과를 세 가지로 나타낼 수 있다.\
        \n먼저, 아이에게 전하고 싶었던 말을 웹과 IoT 기기를 통해 전달할 수 있어 아이의 속마음을 알 수 있을 뿐만 아니라 새로운 소통의 창구가 될 것이라 기대된다.\
        \n또한 현재 단계에서는 캐릭터가 하나이며 얼굴인식과 카메라 필터, 3D 렌더링 기능 등이 구현되었지만 이것 외에 동화 읽어주기, Teachable Machine을 활용한 교육 프로그램 제공 등 언제든지 다양한 기능을 추가할 수 있기 때문에 확장성이 매우 높다.\
        \n마지막으로 병원에서 활동이 제한된 아이들에게 언제든지 찾아가서 놀고 대화하며 시간을 보낼 수 있는 곳이 생긴다는 것에서 아이들에게 매일매일이 이벤트같은 날들을 줄 수 있지 않을까를 기대한다.\
