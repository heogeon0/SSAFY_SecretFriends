...
class FaceRecog():
    def __init__(self):
        ...
        # firebase
        config = {
            "apiKey": "AIzaSyBkdppI7NQyMJr5uz1kwasDvsBVQWrBfXc",
            "authDomain": "my-buddy-359c8.firebaseapp.com",
            "projectId": "my-buddy-359c8",
            "storageBucket": "my-buddy-359c8.appspot.com",
            "messagingSenderId": "377294439460",
        ...
        # all_files = storage.child("knowns/").list_files()
...
if __name__ == '__main__':
    ...
    while True:
        frame, face_names = face_recog.get_frame()
